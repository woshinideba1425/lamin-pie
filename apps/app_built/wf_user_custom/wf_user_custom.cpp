...
namespace LAMINATEPIE {
    namespace BUILTIN_APP {
        ...
        bool WF_User_Custom::_choose_watch_face()
        {
            ...
            _data.panel_wf_select = lv_obj_create(ui_wf_user_screen);
        ...
        bool WF_User_Custom::_create_watch_face()
        {
            ...
            if (_custom_data.using_gif_bg) {
                ...
                // _data.img_bk_gif = lv_gif_create(ui_wf_user_screen);
                ...
                _data.img_bg_static = lv_img_create(ui_wf_user_screen);
        ...
        {
            setTaskName("Cutom Watch Face");
            setScreen(ui_wf_user_screen);
            setAllowBgRunning(false);
            setAppIcon((void*)&ICON_WF_USER);
        }
        ...
        void WF_User_Custom::onCreate()
        {
            ...
            _data.time_ptr = (DataTime_t*)db->Get(LA_TIME)->addr;
            _data.just_wake_up_ptr = (bool*)db->Get(LA_JUST_WAKEUP)->addr;

            //_data.key_home_ptr = (bool*)db->Get(LA_KEY_HOME)->addr;
            /* Reset at first */
            //*_data.key_home_ptr = false;

            /* Lock scroll */
            lv_obj_set_scroll_dir(ui_wf_user_screen, LV_DIR_NONE);
            /* Add event callback */
            lv_obj_add_event_cb(ui_wf_user_screen, _lvgl_event_cb, LV_EVENT_ALL, (void*)this);
