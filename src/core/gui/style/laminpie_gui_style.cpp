...
bool StyleSize::calibrate(const StyleSize &parent)
{
    ...
    if (flags.enable_width_auto) {
        ...
        CheckValueAndReturn(width_percent, 1, 100, false, "Invalid width percent");
        width = (parent_w * width_percent) / 100;
    } else {
        CheckValueAndReturn(width, 1, parent_w, false, "Invalid width");
    }
    ...
    if (flags.enable_height_auto) {
        ...
        CheckValueAndReturn(height_percent, 1, 100, false, "Invalid Height percent");
        height = (parent_h * height_percent) / 100;
    } else {
        CheckValueAndReturn(height, 1, parent_h, false, "Invalid Height");
    }
...
bool StyleSize::calibrate(const StyleSize &parent, bool allow_zero)
{
    ...
    if (flags.enable_width_auto) {
        ...
        CheckValueAndReturn(width_percent, min_size, 100, false, "Invalid width percent");
        width = (parent_w * width_percent) / 100;
    } else {
        CheckValueAndReturn(width, min_size, parent_w, false, "Invalid width");
    }
    ...
    if (flags.enable_height_auto) {
        ...
        CheckValueAndReturn(height_percent, min_size, 100, false, "Invalid Height percent");
        height = (parent_h * height_percent) / 100;
    } else {
        CheckValueAndReturn(height, min_size, parent_h, false, "Invalid Height");
    }
...
process_height:
    ...
    if (flags.enable_height_percent) {
        CheckNullAndReturn(parent, false, "Invalid parent");
        CheckValueAndReturn(height_percent, 1, 100, false, "Invalid height percent");
        height = (parent->height * height_percent) / 100;
    } else if (parent != nullptr) {
        CheckValueAndReturn(height, 1, parent->height, false, "Invalid height");
    }
...
{
    CheckNullAndReturn(resource, false, "Invalid resource");
