...
#define LAMINPIE_LOG_TAG "LAMINPIE:LVGL"

#if LAMINPIE_LVGL_ENABLE_DEBUG_LOG
#   define LAMINPIE_LVGL_LOG_TRACE(fmt, ...) LP_MOD_LOG_TRACE(LAMINPIE_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG, fmt, ##__VA_ARGS__)
#   define LAMINPIE_LVGL_LOG_DEBUG(fmt, ...) LP_MOD_LOG_DEBUG(LAMINPIE_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG, fmt, ##__VA_ARGS__)
#   define LAMINPIE_LVGL_LOG_INFO(fmt, ...) LP_MOD_LOG_INFO(LAMINPIE_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG, fmt, ##__VA_ARGS__)
#   define LAMINPIE_LVGL_LOG_WARN(fmt, ...) LP_MOD_LOG_WARN(LAMINPIE_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG, fmt, ##__VA_ARGS__)
#   define LAMINPIE_LVGL_LOG_ERROR(fmt, ...) LP_MOD_LOG_ERROR(LAMINPIE_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG, fmt, ##__VA_ARGS__)
#else
