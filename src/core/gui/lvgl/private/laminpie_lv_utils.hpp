...
#   define LAMINPIE_LVGL_LOG_TRACE_ENTER() LP_MOD_LOG_TRACE_ENTER(LV_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG)
#   define LAMINPIE_LVGL_LOG_TRACE_EXIT() LP_MOD_LOG_TRACE_EXIT(LV_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG)
#   define LAMINPIE_LVGL_LOG_TRACE_ENTER_WITH_THIS() LP_MOD_LOG_TRACE_ENTER_WITH_THIS(LV_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG)
#   define LAMINPIE_LVGL_LOG_TRACE_EXIT_WITH_THIS() LP_MOD_LOG_TRACE_EXIT_WITH_THIS(LV_LOG_TAG, LAMINPIE_LVGL_ENABLE_DEBUG_LOG)
...
#else
#   define LAMINPIE_LVGL_LOG_TRACE_ENTER() ((void)0)
#   define LAMINPIE_LVGL_LOG_TRACE_EXIT() ((void)0)
#   define LAMINPIE_LVGL_LOG_TRACE_ENTER_WITH_THIS() ((void)0)
#   define LAMINPIE_LVGL_LOG_TRACE_EXIT_WITH_THIS() ((void)0)
