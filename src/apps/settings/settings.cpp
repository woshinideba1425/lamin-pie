...
namespace LAMINATEPIE {
    namespace BUILTIN_APP {
        ...
        void Settings::_set_time()
        {
            ...
            DataTime_t time_buffer = db->Get(LA_TIME)->value<DataTime_t>();
            ...
            /* Get Month */
            time_buffer.mon = lv_roller_get_selected(_data.roller_month) + 1;

            /* Get Mday */
            time_buffer.mday = lv_roller_get_selected(_data.roller_mday) + 1;

            /* Get Year(o.O) */
            time_buffer.year = 2024;
            ...
            /* Push into database */
            db->Put<DataTime_t>(LA_TIME, time_buffer);

            /* Set flag */
            db->Put<bool>(LA_TIME_JSUT_SET, true);
        ...
        {
            setTaskName("Settings");
            setScreen(ui_wf_settings_screen);
            setAllowBgRunning(true);
            setAppIcon((void*)&ICON_SETTINGS);
        }
        ...
        void Settings::onCreate()
        {
            ...
            // _data.key_home_ptr = (bool*)getDatabase()->Get(LA_KEY_HOME)->addr;
            // /* Reset at first */
            // *_data.key_home_ptr = false;

            /* Add event callback */
            lv_obj_add_event_cb(ui_wf_settings_screen, _lvgl_event_cb, LV_EVENT_ALL, (void*)this);
            /* Set user data */
            lv_obj_set_user_data(ui_wf_settings_screen, this);


            /* Create setting widgets */
            lv_obj_t* label_hour = lv_label_create(ui_wf_settings_screen);
            ...
            lv_obj_t* label_min = lv_label_create(ui_wf_settings_screen);
            ...
            lv_obj_t* label_banner = lv_label_create(ui_wf_settings_screen);
            ...
            lv_obj_t* label_month = lv_label_create(ui_wf_settings_screen);
            ...
            lv_obj_t* label_mday = lv_label_create(ui_wf_settings_screen);
            ...
            _data.roller_hour = lv_roller_create(ui_wf_settings_screen);
            ...
            _data.roller_min = lv_roller_create(ui_wf_settings_screen);
            ...
            _data.roller_month = lv_roller_create(ui_wf_settings_screen);
            ...
            _data.roller_mday = lv_roller_create(ui_wf_settings_screen);
            ...
            _data.button_set = lv_btn_create(ui_wf_settings_screen);
